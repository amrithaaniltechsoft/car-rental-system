        ...
        <div class="text-left">
            ...
            <table class="table table-sm table-borderless mb-0">
                <tr>
                    ...
                    <td class="text-right text-dark"><strong>{{ number_format((float) $invoice->subtotal, 2) }} OMR</strong></td>
                </tr>
                <tr>
                    <td><strong>VAT ({{ number_format((float) $invoice->vat, 2) }}%)</strong></td>
                    <td class="text-right text-dark"><strong>{{ number_format((float) $invoice->vat_amount, 2) }} OMR</strong></td>
                </tr>
                <tr class="table-active">
                    <td><strong>Total Amount</strong></td>
                    <td class="text-right text-dark"><strong>{{ number_format((float) $invoice->total, 2) }} OMR</strong></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        @if($invoice->booking)
            ...
            <p class="text-muted mt-1 mb-0">
                {{ $invoice->booking->vehicle->name }} ({{ $invoice->booking->vehicle->number_plate }} - {{ $invoice->booking->vehicle->number_code }})<br>
